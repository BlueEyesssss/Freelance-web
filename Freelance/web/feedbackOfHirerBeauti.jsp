                ...
                <div class="icon-wrapper">
                    <div class="div-block-3">
                        <div data-hover="true" data-delay="0" class="link-4 nav-link w-dropdown">
                            ...
                            <nav class="dropdown-list-2 w-dropdown-list"><a href="postAJob.jsp" class="dropdown-link-nav w-dropdown-link">Post a
                                    Job</a><a href="MainController?action=ViewContractOfHirer" class="dropdown-link-nav w-dropdown-link">All contract</a><a href="#"
                    ...
                    <div class="navigation-button-wrapper">
                        <div data-hover="false" data-delay="0" class="w-dropdown">
                            ...
                            <nav class="dropdown-list-2 w-dropdown-list"><a href="MainController?action=ViewHirerProfile" class="dropdown-link w-dropdown-link">My
                                    Profile</a>
                    ...
                    <div class="div-block-40">
                        <div class="list-skill-copy">
                                ...
                                <%
                                    ...
                                    int jobPosted = hirerDao.getJobPosted(hirer.getHirerID());
                                %>
                <div class="div-block-32">
                    <div class="div-block-41">
                        <h4 class="heading-12">About the Client</h4>
                        <div class="text-block-39"><strong>Company: <%= hirer.getCompanyName()%></strong></div>
                        <div class="text-block-39-copy"><%= hirer.getLocation()%></div>
            ...
            <div class="div-block-45">
                ...
                <div class="form-block w-form">
                    ...
                    <form action="MainController" id="email-form-3" name="email-form-3" data-name="Email Form 3" method="get"><label
                            ...
                            <input type="submit" name="action" value="FeedbackOfHirer"
