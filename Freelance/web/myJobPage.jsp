    ...
    <div class="container-3 w-container">
        <div class="invitations-wrapper">
            ...
            <div class="submit-1">
                ...
                <div class="project-submit"><a href="MainController?action=ViewActiveProject&projectID=<%= proposal.getProjectID() %>" class="job-submit"><%= proposal.getProjectName()  %></a></div>
