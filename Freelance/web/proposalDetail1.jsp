...
<body class="body">
    ...
    <%
        ProposalDTO proposalDetaiil = (ProposalDTO)request.getAttribute("PROPOSAL_DETAIL");
    ...
    <div class="proposal-detail-wrapped w-container">
        ...
        <%
            for (HirerDTO elem : listHirer) {
                    if(proposalDetaiil.getHirerID() == elem.getHirerID()){
                    %>
                        <div class="client">
                            ...
                            <div class="country_city-wrapper">
                                <div class="viet-nam"><%= elem.getLocation() %></div>
                                <div class="ho-chi-minh-00-01-am"></div>
                            </div>
                            <div class="history-details">
                                ...
                                <div>
                                    <div class="text-block-23">5 to 10 proposals<br /><%= elem.getJobPosted() %> jobs posted<br />$27,684 total spent<br />3
