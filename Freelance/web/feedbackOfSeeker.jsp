...
<head>
    ...
    <link
        href="https://uploads-ssl.webflow.com/62a2177bc3e3fe325e19629d/css/proposal-detail-fixed.webflow.4e673dcfb.css"
        ...
        <div class="proposal-text">
            <div class="div-block">
                ...
                <div class="div-block-19">
                    <div class="change-term-button-wrapper">
                                    ...
                                    <div class="feedback-wrapper">
                                        ...
                                        <div class="div-block-22">
                                            <div class="div-block-23">
                                                <div class="w-form">
                                                    <form id="email-form-6" name="email-form-6" data-name="Email Form 6" action="MainController"
                                                        method="get"><input type="text"
                                                            class="feedback-grade-input w-input" maxlength="256"
                                                            name="field-4" data-name="Field 4" placeholder="Input Grade"
                                                            id="field-4" required="" />
                                                    <textarea placeholder="Comment here" maxlength="5000"
                                                            id="field-6" name="field-6" data-name="field"
                                                            class="textarea w-input"></textarea>
                                                            
                                                            <a class="button w-button"><button type="submit" name="action" value="FeedbackOfSeeker"class="log-in">Send</a></button>
                                                            <a
                                                data-w-id="ae304b1c-92b2-b2e3-9b13-51aa3ffcdd7d" href="#"
...
<!--                                            <div>
                                                <div class="w-form">
                                                    <form id="email-form-7" name="email-form-7" data-name="Email Form 7"
                                                        method="get"><textarea placeholder="Comment here" maxlength="5000"
                                                            id="field-6" name="field-6" data-name="field"
                                                            class="textarea w-input"></textarea></form>
                                                    <div class="w-form-done">
                                                        <div>Thank you! Your submission has been received!</div>
                                                    </div>
                                                    <div class="w-form-fail">
...
<!--                                            <a href="MainController?action=FeedbackOfSeeker" class="button-8 w-button">Send</a><a
                                                data-w-id="ae304b1c-92b2-b2e3-9b13-51aa3ffcdd7d" href="#"
                                                class="button-7 w-button">Cancel</a>-->
                                        </div>
                                    </div>
    ...
    <script src="https://uploads-ssl.webflow.com/62a2177bc3e3fe325e19629d/js/webflow.be896c09e.js"
