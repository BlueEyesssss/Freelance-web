 ...
 * @author Admin
 */
@WebServlet(name = "ViewActiveProjectController", urlPatterns = {"/ViewActiveProjectController"})
public class ViewActiveProjectController extends HttpServlet {
    ...
    private static final String SUCCESS = "activeProjectPage.jsp";
