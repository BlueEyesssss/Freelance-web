 ...
 * @author Admin
 */
@WebServlet(name = "PostedProjectDetailController", urlPatterns = {"/PostedProjectDetailController"})
public class PostedProjectDetailController extends HttpServlet {

    private static final String ERROR = "postedProjectDetails.jsp";
    private static final String SUCCESS = "postedProjectDetails.jsp";
...
//            }
            ...
            log("Error at PostedProjectDetailController: " + e.toString());
        } finally {
