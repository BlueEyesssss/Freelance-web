 ...
 * @author Admin
 */
@WebServlet(name = "ViewSeekerProfileController", urlPatterns = {"/ViewSeekerProfileController"})
public class ViewSeekerProfileController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            List<ProposalDTO> list = dao.getHistoryProject(seekerID);
            if(!list.isEmpty()) {
