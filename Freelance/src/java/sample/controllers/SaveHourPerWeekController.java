 ...
 * @author LENOVO
 */
@WebServlet(name = "SaveHourPerWeekController", urlPatterns = {"/SaveHourPerWeekController"})
public class SaveHourPerWeekController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if(session != null){
                ...
                if(daoSeeker.UpdateHourPerWeekSeeker(seeker.getSeekerID(), hourPerWeek)){
                    //cập nhật lại seeker
                    seeker.setHourPerWeek(hourPerWeek);
